...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 disabled:border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
          "bg-[#e13a60] text-primary-foreground hover:from-blue-700 hover:to-blue-700 text-white",
        destructive:
          "bg-gradient-to-b from-[#de5070] to-[#e13a60] text-destructive-foreground hover:from-[#e13a60] hover:to-[#e13a60]",
        outline:
