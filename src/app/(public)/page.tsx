    ...
    <div className="flex min-h-[100dvh] flex-col">
      ...
      >
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex gap-4 items-center">
            ...
            <Button onClick={() => redirect('/sign-in')} className="rounded-full">
              Зарегистрироваться
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
              className="md:hidden absolute top-16 inset-x-0 bg-background-transparent/95 border-b"
          >
      ...
      <main className="flex-1">
        ...
        <section className="w-full min-h-screen overflow-hidden flex relative -mt-16">
          <div className="container px-4 md:px-6 bg-linear-to-t from-primary to-indigo-500 flex flex-col justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Kanata Planner — не просто планировщик!
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Управляйте проектами, повседневными задачами и финансами без лишних хлопот.
              </p>
